...
<body>
    <form action="{{ route('lab.genpdf', $questionario) }}" method="post">
        @csrf
    <input id="id" name="form" type="hidden" value="{{ $LoggedUserInfo->id }}"> 
    ...
    <button id ="bg" type=”submit” >Salva Questionario</button> <button type="button" id="bg"  onclick="window.location='{{ URL::route('lab.nuovoQuest') }}'">Annulla</button></td>
