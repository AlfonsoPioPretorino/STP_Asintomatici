   ...
   <div class="container" align="center">
      <div class="ro" style="margin-top:45px">
         <div class="col-md-4 col-md-offset-4">
              <h4>| Registrazione Datore di Lavoro | </h4><hr>
         </div>
      </div>
   </div>
   <div class="container">
      <form action="{{ route('dat.save') }}" method="post">
      ...
      <div class="row">
       ...
       <div class="col">
            ...
            <input type="text" class="form-control" name="partitaIVA" placeholder="Inserisci partita IVA" value="{{ old('PartitaIva') }}">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nomeattivit" placeholder="Inserisci nome attività" value="{{ old('nomeattivit') }}">
                <span class="text-danger">@error('nomeattivit'){{ $message }} @enderror</span>
            </div>
        </div>
       <div class="col">
