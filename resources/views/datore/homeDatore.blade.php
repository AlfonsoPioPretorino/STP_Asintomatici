...
<body>
	...
	<div id="bottonimenu2">
		...
		<button type="button" id="pulsante"  onclick="window.location='{{ URL::route('datore.visualPren')}}'">Visualizza Prenotazioni</button></td>
		<button type="button" id="pulsante"  onclick="window.location='{{ URL::route('datore.visualEsiti')}}'">Visualizza Esiti Dipendenti</button>
