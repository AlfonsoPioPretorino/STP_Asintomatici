<head>
    ...
    <div class="sez">
        ...
        <p>Il/La prenotato/a dovrà presentarsi il giorno {{$nropre->Data}} in ora {{$nropre->Orario}} presso il laboratorio {{$infolab->nome}} in {{$infolab->indirizzo}} ({{$infolab->citta}}).</p>
        <p>Il servizio è offerto al costo di {{$infotamp->Prezzo}}€ per il tampone prenotato/a.</p>
    </div>
    <br>
    <br>
    <br>
