...
<div id="menu">
    ...
    <li id="hm"><a href="{{route('home.medico')}}">← Torna alla home</a></li>
        ...
        <li id="hm"><a style="color:#766ec5;"   href="{{route('med.Esito')}}"><u>Visualizza Esiti Tamponi Assistiti</u></a></li>
    <ul>
</div>

<div id="distacco">
<h1 align="center" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;"> Elenco Esiti Tampone Effettuati</h1>
</div>
<div id="distacco">
