...
overflow-y: auto;
  ...
  .modal__circle {
    ...
    --bg-opacity:1;
 background-image: url(/img/sfondo_verticale.jpg);
...
<div class="modal">
    <div class="modal__container">
      <div class="modal__featured">
        <button type="button" class="button--transparent button--close" onclick="window.location='{{ URL::route('ut.visualizzaprenotazioni')}}'">
        ...
        <img src="/img/Logo_finale_verticale.png" class="modal__product" />
      </div>
      <div class="modal__content">
        <h2>Dettagli Pagamento</h2>

        <form action="{{ route('home.utente') }}" method="get">
          <ul class="form-list">
            ...
            <li class="form-list__row form-list__row--inline">
              ...
              <div>
                ...
                <input type="text"  placeholder="123"  minlength="3" maxlength="4" required=""  />
              </div>
            </li>
            <li class="form-list__row form-list__row--agree">
              <label>
                <input type="checkbox" name="save_cc" checked="checked">
                Salva carta di credito per futuri pagamenti
              </label>
            </li>
            <li>
